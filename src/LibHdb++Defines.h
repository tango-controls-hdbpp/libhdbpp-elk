...
const std::string SC_COL_VALUE_R = "value_read";
const std::string SC_COL_VALUE_W = "value_write";
...
const std::string EXCEPTION_TYPE_SAVEEVENTDATA = "ErrorInSavingAttributeEventData";
